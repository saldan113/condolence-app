...
def run_monthly_report():
    ...
    # 1. Authenticate with Google Sheets using the local inject
    ...
    # 3. Filter for current month's entries
    ...
    # 4. Generate Jamaat Breakdown Table (HTML)
    ...
    # 5. Generate Updated Historical Audit Log List (HTML)
    audit_list_items = ""
